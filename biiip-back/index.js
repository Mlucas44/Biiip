  ...
  try {
    ...
    if (existingPourboiresCount === 0) {
      ...
      const pourboiresData = [
        { amount: 2.50, rating: 5, review: 'Nouveau pourboire' },
        { amount: 3.00, rating: 4, review: 'Nouveau pourboire' },
        { amount: 4.25, rating: 5, review: 'Nouveau pourboire' },
        { amount: 1.50, rating: 3, review: 'Nouveau pourboire' },
        { amount: 2.75, rating: 4, review: 'Nouveau pourboire' },
        { amount: 5.00, rating: 5, review: 'Nouveau pourboire' },
        { amount: 3.50, rating: 4, review: 'Nouveau pourboire' },
        { amount: 2.00, rating: 3, review: 'Nouveau pourboire' },
        { amount: 1.00, rating: 2, review: 'Nouveau pourboire' },
        { amount: 4.00, rating: 5, review: 'Nouveau pourboire' },
        { amount: 2.20, rating: 3, review: 'Nouveau pourboire' },
        { amount: 3.75, rating: 4, review: 'Nouveau pourboire' },
        { amount: 4.50, rating: 5, review: 'Nouveau pourboire' },
        { amount: 2.10, rating: 3, review: 'Nouveau pourboire' },
        { amount: 1.75, rating: 2, review: 'Nouveau pourboire' },
        { amount: 2.45, rating: 4, review: 'Nouveau pourboire' },
        { amount: 3.00, rating: 3, review: 'Nouveau pourboire' },
        { amount: 3.10, rating: 4, review: 'Nouveau pourboire' },
        { amount: 4.80, rating: 5, review: 'Nouveau pourboire' },
        { amount: 2.50, rating: 3, review: 'Nouveau pourboire' },
      ];
